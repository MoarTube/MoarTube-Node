...
import type { DrizzleLink, DrizzleNewLink } from '@/database/schemas/sqlite/links.js';
import type { DatabaseClient } from '@database/sqlite-connection.js';
import { links } from '@/database/schemas/sqlite/links.js';

export class LinksRepositorySQLite implements ILinksRepository<DrizzleLink, DrizzleNewLink> {
