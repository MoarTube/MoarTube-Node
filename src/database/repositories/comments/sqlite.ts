...
import type { DrizzleComment, DrizzleNewComment } from '@database/schemas/sqlite/comments.js';
import type { DatabaseClient } from '@database/sqlite-connection.js';
import { comments } from '@database/schemas/sqlite/index.js';
import { eq, desc, and, gt, lt, like, count } from 'drizzle-orm';

export class CommentsRepositorySQLite implements ICommentsRepository<DrizzleComment, DrizzleNewComment> {
