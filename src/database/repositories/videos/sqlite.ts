...
import { videos } from '@database/schemas/sqlite/index.js';
...
/**
 * VideosRepositorySQLite class for video CRUD operations using SQLite
 */
export class VideosRepositorySQLite implements IVideosRepository<DrizzleVideo, DrizzleNewVideo> {
