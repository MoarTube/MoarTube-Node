# MoarTube-Node
A repository containing the [MoarTube](https://www.moartube.com) node software. Get involved with the platform or do your own thing and run your node privately. The software makes video and live streams so easy you'll be amazed beyond belief.
...
## How to Get Started
MoarTube Node can be found on [DockerHub](https://hub.docker.com/r/moartube/moartube-node), or follow the manual approach. The default login credentials for your node are below. Be sure to change these upon logging in.
