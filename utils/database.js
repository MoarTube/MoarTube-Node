    ...
    return new Promise(function(resolve, reject) {
        ...
        database = new sqlite3.Database(getDatabaseFilePath(), async function(error) {
            if (error) {
                ...
                const didSocialMediasTableExist = ((await performDatabaseReadJob_GET(`SELECT name FROM sqlite_master WHERE type='table' AND name='socialMedias';`, [])) != null);
                ...
                await performDatabaseWriteJob('CREATE TABLE IF NOT EXISTS socialMedias(social_media_id INTEGER PRIMARY KEY, link TEXT, svg_graphic TEXT, timestamp INTEGER)', []);
                ...
                if(!didSocialMediasTableExist) {
                    let link;
                    let svgGraphic;
                    let timestamp = Date.now();

                    link = 'https://github.com/MoarTube';
                    ...
                    await performDatabaseWriteJob('INSERT INTO socialMedias(link, svg_graphic, timestamp) VALUES (?, ?, ?)', [link, svgGraphic, timestamp]);

                    link = 'https://discord.gg/rrKF7a86rY';
                    ...
                    link = 'https://twitter.com/MoarTubes';
                    ...
                    link = 'https://www.patreon.com/MoarTube';
