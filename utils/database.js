    ...
    return new Promise(function(resolve, reject) {
        ...
        database = new sqlite3.Database(getDatabaseFilePath(), async function(error) {
            if (error) {
                ...
                await performDatabaseWriteJob('CREATE TABLE IF NOT EXISTS links(link_id INTEGER PRIMARY KEY, link TEXT, svg_graphic TEXT, timestamp INTEGER)', []);
                ...
                if(!didLinksTableExist) {
                    ...
                    await performDatabaseWriteJob('INSERT INTO links(link, svg_graphic, timestamp) VALUES (?, ?, ?)', [link, svgGraphic, timestamp]);
